        ...
        <a class="navbar-brand" href="index.php">SYNERGY BANK <img src="logos/bankl.jfif" alt="Bank" width="50" height="50"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="nav nav-pills me-auto mb-8 mb-lg-0">
                    ...
                    <li class="nav-item py-3">
                        <a class="nav-link " aria-current="page" href="About.php"><strong>About US</strong></a>
                    </li>
...
<class class="welcome">
        <h2>
            <img src="logos/tt1.png" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History</strong> <img
                src="logos/tt2.png" alt="Bank" width="75" height="75">
        </h2>
    </class>
