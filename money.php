...
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/mt1.png" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money
                Transfer</strong> <img src="logos/mt2.png" alt="Bank" width="75" height="75">
        </h2>
    </class>
